...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-aln-orange via-aln-orange-light to-aln-orange bg-aln-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/products">
                <Button size="lg" className="bg-aln-orange hover:bg-aln-orange-dark text-white px-8 py-3 text-lg">
                  Shop Now
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link to="/products?filter=new">
                <Button variant="outline" size="lg" className="border-aln-orange text-aln-orange hover:bg-aln-orange hover:text-white px-8 py-3 text-lg">
                  New Arrivals
                </Button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-aln-orange rounded-full mb-4">
              ...
              <Link key={index} to={category.href}>
                <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer group">
                  ...
                  <CardContent className="p-4">
                    <h3 className="text-lg font-semibold text-center group-hover:text-aln-orange transition-colors">
                      {category.name}
                    </h3>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link to="/products">
              <Button size="lg" className="bg-aln-orange hover:bg-aln-orange-dark">
                View All Products
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
      ...
      {/* Newsletter */}
      <section className="py-16 bg-aln-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-md mx-auto flex gap-4">
            ...
            />
            <Button className="bg-aln-orange hover:bg-aln-orange-dark px-6">
              Subscribe
            </Button>
          </div>
        </div>
